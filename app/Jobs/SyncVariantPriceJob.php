...
final class SyncVariantPriceJob extends ChannelSyncJob
{
    ...
    {
        return app(ConnectorRegistry::class)->for($operation->account->channel->code)->updatePrice(new ChannelRequest($operation->tenant_id, $operation->channel_account_id, $operation->entity_id));
    }
